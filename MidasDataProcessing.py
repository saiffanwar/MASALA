...
class MidasDataProcessing():
    ...
    def fetchData(self, location='heathrow'):
        # print('DATA FETCHED')
        df2020 = pd.read_csv(os.getcwd()+'/MIDAS/'+location+'_weather_2020.csv', skiprows =280, skipfooter=1, engine='python')
        rain_2020 = pd.read_csv(os.getcwd()+'/MIDAS/'+location+'_rain_2020.csv', skiprows =61, skipfooter=1, engine='python')
        df2020 = df2020[self.availableFeatures]
        df2020['prcp_amt'] = rain_2020['prcp_amt']

        df2021 = pd.read_csv(os.getcwd()+'/MIDAS/'+location+'_weather_2021.csv', skiprows =280, skipfooter=1, engine='python')
        rain_2021 = pd.read_csv(os.getcwd()+'/MIDAS/'+location+'_rain_2021.csv', skiprows =61, skipfooter=1, engine='python')
        df2021 = df2021[self.availableFeatures]
        df2021['prcp_amt'] = rain_2021['prcp_amt']

        df2022 = pd.read_csv(os.getcwd()+'/MIDAS/'+location+'_weather_2022.csv', skiprows =280, skipfooter=1, engine='python')
        rain_2022 = pd.read_csv(os.getcwd()+'/MIDAS/'+location+'_rain_2022.csv', skiprows =61, skipfooter=1, engine='python')
    ...
    def train_val_test_split(self, df, target_col, test_ratio):
        ...
        X_train, X_val, y_train, y_val = train_test_split(X_train, y_train, test_size=val_ratio, shuffle=True, random_state=42)
