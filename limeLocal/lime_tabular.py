...
from limeLocal.discretize import QuartileDiscretizer
from limeLocal.discretize import DecileDiscretizer
from limeLocal.discretize import EntropyDiscretizer
from limeLocal.discretize import BaseDiscretizer
from limeLocal.discretize import StatsDiscretizer
...
class LimeTabularExplainer(object):
    ...
    def explain_instance(self,
        ...
        # Normalise distances
        distances = [d/np.max(distances) for d in distances]
