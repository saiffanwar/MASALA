...
parser.add_argument('-m', '--mode', type=str, default='random', help='Whether to generate ensembles or explanations.')
...
#    for kernel_width in kernel_widths:
    ...
    if args.lime or args.chilli:
        for kernel_width in kernel_widths:
            if args.chilli:
                CHILLIExplainer = CHILLI(dataset, base_model.model, base_model.x_train, base_model.y_train, base_model.x_test, base_model.y_test, base_model.y_test_pred, base_model.features, using_chilli=True)
            ...
            if args.lime:
                LIMEExplainer = CHILLI(dataset, base_model.model, base_model.x_train, base_model.y_train, base_model.x_test, base_model.y_test, base_model.y_test_pred, base_model.features, using_chilli=False)
